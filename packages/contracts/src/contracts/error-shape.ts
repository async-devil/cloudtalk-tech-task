...
/**
 * The uniform wire error shape (ADR-0002/ADR-0004): `code` is one of the kernel `ErrorCode`
 ...
 *
 * `code` derives from `@repo/kernel`'s `ERROR_CODES` (ADR-0002) — the wire shape can no longer
